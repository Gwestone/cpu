...
VERILOG_SOURCES 	+= $(PWD)/rtl/mul_types.sv
VERILOG_SOURCES 	+= $(PWD)/rtl/mul_mask_decoder.sv
...
VERILOG_SOURCES 	+= $(PWD)/rtl/mul_controller.sv
VERILOG_SOURCES 	+= $(PWD)/rtl/mul.sv

COCOTB_TOPLEVEL 	= main
COCOTB_TEST_MODULES += tests.RV32I_ISA_tb,tests.RV64I_ISA_tb,tests.RV64M_ISA_tb
